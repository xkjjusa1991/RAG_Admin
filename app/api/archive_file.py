...
LastEditTime: 2025-06-20 15:01:33
...
@router.get("/", response_model=ResponseBase[List[ArchiveFileSchema]], summary="获取归档文件列表")
async def list_files(
    ...
    """分页获取归档文件列表"""
    skip = (page - 1) * limit
    files = await crud_archive_file.get_multi(db, skip=skip, limit=limit)
